...
$title = 'Danh sách đơn lượt xem video Facebook';
            ...
            <div class="col-lg-8">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item font-sans-serif active" aria-current="page"><i class="fas fa-link"></i>
                        Danh sách đơn lượt xem video Facebook</li>
                </ol>
            </div>
    ...
    <div class="card-body">
        <div class="table-responsive scrollbar" id="history"
            ...
            <table class="table table-bordered table-striped fs--1">
                ...
                <tbody class="list">
                    <?php 
                    $result = mysqli_query($conn, "SELECT * FROM table_buff WHERE buff_slug = 'buff-view-video-facebook' ORDER BY buff_id DESC LIMIT 0,15");
