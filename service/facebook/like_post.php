            ...
            <div class="card-header bg-light">
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-auto"><a class="btn btn-falcon-default btn-sm"
                            href="/service/facebook/like-post/list"><span class="fas fa-list fs--2 mr-1"></span> Danh sách
                            đơn</a>
                    </div>
                </div>
            </div>
                ...
                <form action="" id="form_id" class="user" method="POST" accept-charset="utf-8">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="buff_server">Server 1 (<b><?=$row['service_price'];?>₫</b>)
                            (Like người việt thật, max 50k) <b class="text-warning">(Hoạt Động)</b></label>
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="buff_server">Server 2
                            (<b><?=$row['service_price_server_1'];?>₫</b>) (Like việt, rẻ tốt nhất !, max 50k) <b
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="buff_server">Server 3
                            (<b><?=$row['service_price_server_2'];?>₫</b>) (Like Việt Lên cực nhanh có tụt like) <b
                                class="text-warning">(Hoạt Động)</b></label>
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="buff_server">Server 4
                            (<b><?=$row['service_price_server_3'];?>₫</b>)  (Like Clone việt, lên nhanh, max 3k) <b
                                class="text-warning">(Hoạt Động)</b></label>
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="buff_server">Server 5
                            (<b><?=$row['service_price_server_4'];?>₫</b>) (Lên sau 10-30p Chậm Có Tụt) <b
                                class="text-warning">(Hoạt Động)</b></label>
                                </div>

                    <div class="alert alert-warning alert-dismissible fade show fs--1 text-center" role="alert">
                                 - Các Server 1 2 3 Sẽ Gồm Cảm Xúc </div>
                    </div>
                    <?php } ?>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" id="buff_note" class="form-control" rows="3"
                            placeholder="Nhập cảm xúc ví dụ : love" required=""></textarea>
                    </div>
                    ...
                    <center>
                        <button type="button" class="btn btn-primary btn-rounded me-1 mb-1" id="likepostFacebook"
                            onclick="like_post_facebook();"><i class="fa fa-dollar-sign"></i> Thanh Toán</button>
                    </center>
                </form>
                </p>
            </div>
...
function getUID() {
    setTimeout(() => {
        ...
        var tiktok_id = id['match'](/(.*)\/([a-zA-Z0-9]{1,})\/share\/([a-zA-Z0-9.]{2,})\/([a-zA-Z0-9.]{4,})/);
...
function like_post_facebook() {
    ...
    $.ajax({
        ...
        complete: function() {
            wait('#likepostFacebook', true, '<i class="fa fa-dollar-sign"></i> Thanh Toán');
        },
        success: (data) => {
            if (data.error) {
                swal(data.msg, "error");
