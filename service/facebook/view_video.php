...
$result = mysqli_query($conn,"SELECT * FROM table_service WHERE service_slug = 'buff-view-video-facebook'");
            ...
            <div class="card-header bg-light">
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-auto"><a class="btn btn-falcon-default btn-sm"
                            href="/service/facebook/view-video/list"><span class="fas fa-list fs--2 mr-1"></span> Danh sách
                            đơn</a>
                    </div>
                </div>
            </div>
            <div class="card-body bg-light">
                ...
                <form action="" id="form_id" class="user" method="POST" accept-charset="utf-8">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="buff_server">Server 1 (<b><?=$row['service_price'];?>₫</b>) (Trung Bình ổn Định) <b
                    ...
                    <center>
                        <button type="button" class="btn btn-primary btn-rounded me-1 mb-1" id="viewvideoFacebook"
                            onclick="view_video_facebook();"><i class="fa fa-dollar-sign"></i> Thanh Toán</button>
                    </center>
                </form>
                </p>
            </div>
...
function view_video_facebook() {
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'service/facebook/view-video/order',
        type: 'POST',
        dataType: 'JSON',
        data: {
        ...
        beforeSend: function() {
            wait('#viewvideoFacebook', false);
        },
        complete: function() {
            wait('#viewvideoFacebook', true, '<i class="fa fa-dollar-sign"></i> Thanh Toán');
        },
        success: (data) => {
            if (data.error) {
                swal(data.msg, "error");
