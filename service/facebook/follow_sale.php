...
$result = mysqli_query($conn,"SELECT * FROM table_service WHERE service_slug = 'buff-follow-sale-facebook'");
            ...
            <div class="card-header bg-light">
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-auto"><a class="btn btn-falcon-default btn-sm"
                            href="/service/facebook/follow-sale/list"><span class="fas fa-list fs--2 mr-1"></span> Danh sách
                            đơn</a>
                    </div>
                </div>
            </div>
                ...
                <form action="" id="form_id" class="user" method="POST" accept-charset="utf-8">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="buff_server">Server 1 (<b><?=$row['service_price'];?>₫</b>)
                            (Via host, lên nhanh, max 100k, nên dùng, nếu bảo trì lâu thì có thể quay lại vào 12h trưa
                            hôm sau) <b class="text-warning">(Hoạt đông)</b></label>
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="buff_server">Server 2
                            (<b><?=$row['service_price_server_1'];?>₫</b>) (Lên nhanh, sub clone nuôi, max 100K) <b
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="buff_server">Server 3
                            (<b><?=$row['service_price_server_2'];?>₫</b>) (Via việt, max 50k, lên cực nhanh) <b
                                class="text-warning">(Hoạt đông)</b></label>
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="buff_server">Server 4
                            (<b><?=$row['service_price_server_3'];?>₫</b>) (Max 50K, bấm tay) <b
                                class="text-warning">(Hoạt đông)</b></label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="buff_fb_id" name="idfb" onpaste="getUID();" class="form-control"
                            placeholder="Nhập ID profile cần tăng" required="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="buff_amount" name="amount" onkeyup="bill();" class="form-control mb-3"
                            ...
                            Tổng tiền = (Số lượng) x (Giá 1 Follow) </div>
                    </div>
                    <div class="mb-3">
                        <label>Ghi chú:</label>
                    ...
                    <center>
                        <button type="button" class="btn btn-primary btn-rounded me-1 mb-1" id="follow-saleFacebook"
                            onclick="follow_sale_facebook();"><i class="fa fa-dollar-sign"></i> Thanh Toán</button>
                    </center>
                </form>
                </p>
            </div>
...
function getUID() {
    setTimeout(() => {
        ...
        if (!isURL(idfb)) {
            $('#follow-saleFacebook').prop("disabled", false);
            return;
        }
...
function follow-sale_facebook() {
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'service/facebook/follow-sale/order',
        type: 'POST',
        dataType: 'JSON',
        data: {
        ...
        beforeSend: function() {
            wait('#follow-saleFacebook', false);
        },
        complete: function() {
            wait('#follow-saleFacebook', true, '<i class="fa fa-dollar-sign"></i> Thanh Toán');
        },
        success: (data) => {
            if (data.error) {
                swal(data.msg, "error");
