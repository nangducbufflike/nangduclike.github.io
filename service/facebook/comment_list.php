    ...
    <div class="card-header bg-light">
        <div class="row justify-content-between">
            ...
            <div class="col-md-auto"><a class="btn btn-falcon-default btn-sm"
                    href="/service/facebook/comment/order"><span class="fas fa-plus fs--2 mr-1"></span> Thêm đơn</a>
            </div>
        </div>
    </div>
    <div class="card-body">
        <div class="table-responsive scrollbar" id="history"
            data-list='{"valueNames":["buff_id","buff_time","buff_fb_id","buff_server","buff_comment","buff_note","buff_present","buff_payment","buff_status"],"page":10,"pagination":true}'>
            <div class="mb-3">
            ...
            <table class="table table-bordered table-striped fs--1">
                <thead class="bg-200 text-900">
                    <tr>
                        ...
                        <th class="sort" data-sort="buff_comment"><b>Bình luận</b>
                        </th>
                ...
                <tbody class="list">
                    <?php 
                    $result = mysqli_query($conn, "SELECT * FROM table_buff WHERE buff_username = '$user_username' AND buff_slug = 'buff-comment-facebook' ORDER BY buff_id DESC LIMIT 0,15");
                    ...
                    <tr>
                        ...
                        <td class="buff_comment"><?=$row['buff_comment'];?></td>
