    ...
    <div class="card-header bg-light">
        <div class="row justify-content-between">
            ...
            <div class="col-md-auto"><a class="btn btn-falcon-default btn-sm"
                    href="/service/facebook/like-page2/order"><span class="fas fa-plus fs--2 mr-1"></span> Thêm đơn</a>
            </div>
        </div>
    </div>
    <div class="card-body">
        <div class="table-responsive scrollbar" id="history"
            ...
            <table class="table table-bordered table-striped fs--1">
                ...
                <tbody class="list">
                    <?php 
                    $result = mysqli_query($conn, "SELECT * FROM table_buff WHERE buff_username = '$user_username' AND buff_slug = 'buff-like-page2-facebook' ORDER BY buff_id DESC LIMIT 0,15");
